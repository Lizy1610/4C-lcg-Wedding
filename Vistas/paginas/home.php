            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-12">
                    ...
                    <div class="banner__shape2">
                        <img src="HTML/assets/img/banner/banner-shape2.png" alt="banner__shape">
                    </div>
                    <div class="banner__shape3">
                        <img src="HTML/assets/img/banner/banner-shape3.png" alt="banner__shape">
                    </div>
                    <h5 class="wow fadeInUp" data-wow-duration="2s">The Wedding of</h5>
                    <h1 class="wow fadeInDown" data-wow-duration="4s">Lizbeth & Israel</h1>
        ...
        <div class="row g-0">
            <div class="col-xxl-6 col-xl-6 col-lg-6">
                <div class="love__items">
                    <div class="love__thumb wow fadeInDown" data-wow-duration="4s">
                        <img src="HTML/assets/img/love/flower.png" alt="flower__thumb">
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 mt-4">
                <div class="right__thumb wow fadeInUp" data-wow-duration="3s">
                    <img src="HTML/assets/img/love/right.jpg" alt="right__image">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-xxl-6 col-xl-6 col-lg-6 wow fadeInDown" data-wow-duration="3s">
                <div class="testi__items center">
                    <div class="testi__thumb">
                        <img src="HTML/assets/img/testi/testi1.png" alt="testi-image">
                    </div>
                    <div class="testi__content">
                        ...
                        <div class="testi__shape mt-3">
                            <img src="HTML/assets/img/testi/shape.png" alt="flower__image">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xxl-6 col-xl-6 col-lg-6 wow fadeInUp" data-wow-duration="4s">
                <div class="testi__items center">
                <div class="testi__thumb">
                    <img src="HTML/assets/img/testi/testi2.png" alt="testi-image">
                </div>
                <div class="testi__content">
                    <h3>
                        Lizbeth Cruz
